...
settings-display-saturation = Saturación
settings-display-red = Rojo
settings-display-green = Verde
settings-display-blue = Azul
settings-display-screen-resolution = Resolución de Pantalla
...
settings-theme-boxart-underlay = Fondo de Boxart
settings-theme-boxart-border-radius = Radio de Borde de Boxart
...
settings-theme-status-backdrop-color = Color de Fondo de Estado
settings-theme-hide-status-in-launcher = Ocultar Estado en Launcher
settings-theme-button-hint-font-size = Tamaño de Fuente Sugerencia
settings-theme-button-size = Tamaño de Botón
settings-theme-button-text-font-size = Tamaño de Fuente Texto Botón
...
settings-theme-tabs-backdrop-color = Color de Fondo de Pestañas
settings-theme-mirror-tabs-and-status = Espejar Pestañas y Estado
...
ingame-menu-slot-auto = Automático
