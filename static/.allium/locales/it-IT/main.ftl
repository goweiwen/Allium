...
settings-wifi-web-file-explorer = Esplora File Web
...
settings-theme-boxart-underlay = Sfondo Boxart
settings-theme-boxart-border-radius = Raggio Bordo Boxart
...
settings-theme-status-backdrop-color = Colore Sfondo Stato
settings-theme-hide-status-in-launcher = Nascondi Stato nel Launcher
settings-theme-button-hint-font-size = Dimensioni Font Hint
settings-theme-button-size = Dimensioni Pulsante
settings-theme-button-text-font-size = Dimensioni Font Testo Pulsante
...
settings-theme-tabs-backdrop-color = Colore Sfondo Schede
settings-theme-mirror-tabs-and-status = Specchia Schede e Stato
...
settings-needs-restart-for-effect =
    ...
    dispositivo affinché le modifiche
    abbiano effetto.
