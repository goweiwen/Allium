...
settings-wifi-web-file-explorer = Webファイルエクスプローラー
...
settings-theme-boxart-underlay = ボックスアートのアンダーレイ
settings-theme-boxart-border-radius = ボックスアートの角丸
...
settings-theme-status-backdrop-color = ステータスの背景色
settings-theme-hide-status-in-launcher = ランチャーでステータスを非表示
...
settings-theme-tabs-backdrop-color = タブの背景色
settings-theme-mirror-tabs-and-status = タブとステータスを反転
