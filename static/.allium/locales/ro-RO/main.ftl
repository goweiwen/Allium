...
settings-theme-boxart-underlay = Fundal Boxart
settings-theme-boxart-border-radius = Raza Marginii Boxart
...
settings-theme-status-backdrop-color = Culoare Fundal Stare
settings-theme-hide-status-in-launcher = Ascunde Starea în Lansator
...
settings-theme-tabs-backdrop-color = Culoare Fundal File
settings-theme-mirror-tabs-and-status = Oglindește File și Stare
