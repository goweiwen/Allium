...
settings-theme-boxart-underlay = Boxart-Hintergrund
settings-theme-boxart-border-radius = Boxart-Eckenradius
...
settings-theme-status-backdrop-color = Status-Hintergrundfarbe
settings-theme-hide-status-in-launcher = Status im Launcher ausblenden
settings-theme-button-hint-font-size = Button-Hinweis Schriftgröße
settings-theme-button-size = Button-Größe
settings-theme-button-text-font-size = Button-Text Schriftgröße
...
settings-theme-tabs-backdrop-color = Tabs-Hintergrundfarbe
settings-theme-mirror-tabs-and-status = Tabs und Status spiegeln
